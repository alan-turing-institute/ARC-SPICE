...
#SBATCH --qos turing
#SBATCH --job-name baskerville_pipeline_inference_test_translator_larger_bs
...
python scripts/single_component_inference.py /bask/projects/v/vjgo8416-spice/ARC-SPICE/config/RTC_configs/roberta-mt5-zero-shot.yaml /bask/projects/v/vjgo8416-spice/ARC-SPICE/config/data_configs/l1_fr_to_en.yaml 42 baskerville_pipeline_inference_test_large_bs translator